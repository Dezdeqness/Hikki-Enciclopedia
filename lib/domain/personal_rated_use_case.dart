...
class PersonalRatedUseCase {
  final PersonalRepository _personalRepository;
  final PersonalMapper _personalMapper;

  PersonalRatedUseCase(this._personalRepository, this._personalMapper);
  ...
  Future<Result<PersonalCollectionEntity, HikkiApiException>> execute(
    ...
    if (type == PersonalListType.movie) {
      final result = await _personalRepository.getRatedMovies(page: page);
    ...
    final result = await _personalRepository.getRatedTv(page: page);
